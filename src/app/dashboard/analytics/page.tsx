      ...
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-xl p-8">
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          {metrics.map((metric, index) => (
            <div key={index} className={`flex justify-between items-center bg-white rounded-lg
        ...
        <ul className='space-y-4'>
          <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
            <div>
              ...
              <p className="text-sm text-gray-600">New users signed up on 2025-21-06</p>
            </div>
            <div>
          ...
          <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
            <div>
              ...
              <p className="text-sm text-gray-600">The sales this month increased by</p>
            </div>
            <div>
          ...
          <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
            <div>
              <h3 className="text-lg font-semibold text-gray-700">Website traffic</h3>
              <p className="text-sm text-gray-600">Website traffic increased by</p>
            </div>
            <div>
