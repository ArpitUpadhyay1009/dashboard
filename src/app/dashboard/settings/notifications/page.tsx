  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-8">
        ...
        <div className='mb-8'>
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Notification prefrences
          </h2>
          <div className='space-y-4'>
            <div>
              <label className="block text-sm font-medium text-gray-600">Email notifications</label>
              <select className="mt-1 block w-full px-4 py-2 border border-gray-300
        ...
        <div className='flex justify-end space-x-4'>
          ...
          transition-colors">Save changes</button>
        </div>
      </div>
    </div>
  )
